<?php
    ...
    $id = $_GET['ref'];
    $result = activity::getActivityOne($id);
                                    ...
                                    <div class="box">
                                        <header>
                                            ...
                                            <div class="row-fluid" id="activityForm" style="padding-top: 20px">
                                                <form id="inline-validate" class="form-horizontal" method="get" action="action/edit.php" enctype="multipart/form-data">
                                                    <input type="hidden" name="id" value="<?=$row['id'] ?>"> 
                                                    <div class="control-group">
                                                        <label for="text1" name="topic" class="control-label">Topic</label>
                                                        <div class="controls with-tooltip">
                                                            <input type="text" id="text1" name="topic" class="span6 input-tooltip" data-placement="bottom" value="<?=$row['title'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <select class="span6" name="department">
                                                            ...
                                                            ?>
                                                                <option value="<?=$rowd['id']?>" <?php if( $rowd['nameEn'] == $row['department'] ) { echo 'selected="selected"'; } ?>><?=$rowd['nameEn']?></option>
                                                            <?php      
                                                                }
                                                            ?>
                                                        </select>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" class="span6" name="place" value="<?=$row['place'] ?>">
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    <label class="control-label">Start Date</label>
                                                    <div class="controls">
                                                        <input type="text" class="span6" name="startDate" id="dp2" value="<?=date('Y-m-d',strtotime($row['startDate'])) ?>">
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="input-append bootstrap-timepicker-component">
                                                            <input class="timepicker-24 input-small" type="text" name="startTime" value="<?=date('H-i-s',strtotime($row['startDate'])) ?>"><span class="add-on"><i class="icon-time"></i></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" class="span6" name="endDate" id="dp3" value="<?=date('Y-m-d',strtotime($row['endDate'])) ?>">
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="input-append bootstrap-timepicker-component">
                                                            <input class="timepicker-24 input-small" type="text" name="endTime" value="<?=date('H-i-s',strtotime($row['endDate'])) ?>"><span class="add-on"><i class="icon-time"></i></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea class="span6" name="required"><?=$row['description'] ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input class="span6" type="text"value="<?=date('l jS \of F Y h:i A',strtotime($row['createDate'])) ?>" readonly="">
                                                    </div>
                                                </div>
