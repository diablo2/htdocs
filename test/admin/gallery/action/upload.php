...
$targetDir = '../../../file/'. DIRECTORY_SEPARATOR . "gallery/".$albumName;
//$targetDir = 'uploads';
...
if (!$chunking || filesize("{$filePath}.part") >= $_REQUEST["total"]) {
    ...
    $testname = $_FILES['file']['name'];
    $sql = "INSERT INTO photos (albumID, image, createBy, createDate) VALUES ('$albumID','$fileName','$userID', now())";
