...
include ('../assets/class/notification.php');
...
?>
   ...
   <?php     if (!isset($_SESSION['user_id'])){ ?>
    ...
    <script src="../assets/js/lib/perfect-scrollbar.js"></script>
    <script>
      ...
      $('#notification a').click(function(){
        ...
        $('#badge').text('0');
        $.ajax({
          url: '../assets/component/action/updatenotification.php',
          data: 'userID=1',
        })
        });
      $(function(){
      ...
      //     url: '../assets/component/action/countnotification.php',
      //     data: 'userID=1',
