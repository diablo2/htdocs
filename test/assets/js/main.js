...
function formValidation() {
    ...
    $('#inline-validate').validate({
        rules: {
            required: "required",
            topicPR: { // Form Public Relation
                required: true,
            },
            topic: { // Form Activity
                required: true,
            },
            startDate: { // Form Activity
                required: true,
                date: true
            },
            endDate: { // Form Activity
                required: true,
            },
            email: {
                required: true,
...
function metisTable() {
    ...
    $('#dataTable').dataTable({
        "sDom": "<'pull-right'f>t<'row-fluid'<'span6'l><'span6'p>>",
    ...
    /*----------- BEGIN action table CODE - From User-------------------------*/
        // $('#dataTable button.remove').on('click', function() {
        //     $(this).closest('tr').remove();
        // });
        ...
        var val1 = $(this).closest('tr').children('td').eq(1),
                val2 = $(this).closest('tr').children('td').eq(2),
                val3 = $(this).closest('tr').children('td').eq(3),
                val4 = $(this).closest('tr').children('td').eq(4);
        $('#removeModal #col1').text(val1.html());
        $('#removeModal #col2').text(val2.html());
        $('#removeModal #col3').text(val3.html());
        $('#removeModal #col4').text(val4.html());
        $('#userid').text(val1.html());
        removeBtn = $('#btn-remove');
        _href = "action/delete.php?ref=" + val1.html();
        removeBtn.attr('href', _href); 
    ...
    /*----------- BEGIN action table CODE - Album Table -------------------------*/
        ...
        $('#albumTable button.remove').on('click', function() {
        $('#removeModal').modal({
            show: true
        });
        var val1 = $(this).closest('tr').children('td').children('div').eq(0),
            val2 = $(this).closest('tr').children('td').eq(7);
        $('#removeModal #title').text(val1.text());
        $('#removeModal #id').text(val2.text());
        
    });
        $('#btn-remove-album').on('click', function(){
            // $(this).closest('tr').remove();
            var num = $('#id').text();
            $('#tr'+num).remove();
            $.ajax({ // Delete account 
                  type:'get',
                  url:'action/deleteAlbum.php',
                  data:'ref='+ num
            });


        });
        $('#albumTable button.edit').on('click', function() {
            $('#editModal').modal({
                show: true
            });
            var val1 = $(this).closest('tr').children('td').children('div').children('label').eq(1),
                val2 = $(this).closest('tr').children('td').children('div').next().children('label').eq(0),
                val3 = $(this).closest('tr').children('td').eq(7);
            $('#editModal #titleEdit').val(val1.text());
            $('#editModal #description').val(val2.text());
            $('#editModal #albumID').text(val3.text());

            $('#editModal #btn-edit-album').on('click', function() {
            val1.html($('#editModal #titleEdit').val());
            val2.html($('#editModal #description').val());
            $num = $('#editModal #albumID').text();
            $.ajax({ // Update Photo 
                  type:'get',
                  url:'action/updateAlbum.php',
                  data:{
                    ref: $num,
                    title: $('#editModal #titleEdit').val(),
                    des : $('#editModal #description').val()
                }
    ...
    /*----------- BEGIN action table CODE - Photo Table -------------------------*/
        ...
        var val1 = $(this).closest('tr').children('td').children('div').eq(0),
            val2 = $(this).closest('tr').children('td').eq(5);
        $('#removeModal #title').text(val1.text());
        $('#removeModal #photoID').text(val2.text());

            $('#btn-remove-photo').on('click', function(){
            // $(this).closest('tr').remove();
            var num = $('#photoID').text();
            $('#tr'+num).remove();
            $.ajax({ // Delete account 
                  type:'get',
                  url:'action/delete.php',
        ...
        $('#dataTable button.edit').on('click', function() {
            $('#editModal').modal({
                show: true
            });
            var val1 = $(this).closest('tr').children('td').children('div').children('label').eq(1),
                val2 = $(this).closest('tr').children('td').children('div').next().children('label').eq(1);
                val3 = $(this).closest('tr').children('td').eq(5);
            $('#editModal #titleEdit').val(val1.text());
            $('#editModal #description').val(val2.text());
            $('#editModal #photoID').text(val3.text());

            $('#editModal #btn-edit-photo').on('click', function() {
            val1.html($('#editModal #titleEdit').val());
            val2.html($('#editModal #description').val());
            $num = $('#editModal #photoID').text();
            $.ajax({ // Update Photo 
                  type:'get',
                  url:'action/updatePhoto.php',
                  data:{
                    ref: $num,
                    title: $('#editModal #titleEdit').val(),
                    des : $('#editModal #description').val()
    ...
    /*----------- BEGIN action table CODE - Activity Table -------------------------*/
        ...
        $('#activityTable button.remove').on('click', function() {
        $('#removeModal').modal({
            show: true
        });
        var val1 = $(this).closest('tr').children('td').eq(0),
            val2 = $(this).closest('tr').children('td').eq(5);
        $('#removeModal #title').text(val1.text());
        $('#removeModal #activityID').text(val2.text());
                $('#btn-remove-activity').on('click', function(){
            // $(this).closest('tr').remove();
            var num = $('#activityID').text();
            $('#tr'+num).remove();
            $.ajax({ // Delete account 
                  type:'get',
                  url:'action/delete.php',
        ...
        $('#activityTable button.edit').on('click', function() {
            $('#editModal').modal({
                show: true
            });
            var val1 = $(this).closest('tr').children('td').children('div').children('label').eq(1),
