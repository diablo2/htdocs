 ...
 */ 
 ...
 <?
	...
	if(mysql_db_query($dbname,$sql)) {
		...
		echo "หากคำถามของคุณไม่ขึ้นให้กดปุ่ม Refresh/Reload ครับ";
		echo "</font></td></tr></table>";
		echo "<br><hr color=FF1493 width=600>";
		echo "<font size=2 face='MS Sans Serif'>";
		echo "[ <a href='../webboard/postq.php?Category=$Category&page=$page'>ตั้งคำถามใหม่</a> | ";
		echo "<a href='../webboard/webboard.php?Category=$Category'>แสดงคำถาม</a> ]";
		echo "<font>";
		echo "</center>";
		if($Member && $QPic_name) {
			unlink($QPic_name);
