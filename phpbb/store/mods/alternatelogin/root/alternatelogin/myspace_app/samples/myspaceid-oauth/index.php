...
function main() {
	...
	if (@$_GET['f'] == 'start') {
		  ...
		  $tok = $ms->getRequestToken("http://www.consof.com/myspace/samples/myspaceid-oauth/index.php?f=callback");
...
//		  }
		...
		// not authenticated yet, so give a link to use to start authentication.
  		?><p>
<a href="../../../../../../myspace/samples/myspaceid-oauth/<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>?f=start">Click here to authenticate with MySpace</a></p><?php
 	}
}
